...
public abstract interface ShulkerEntityAccessor {
	public abstract void runTryAttachOrTeleport();
	public abstract void setPeekAmount(int amount);
	public abstract int runGetPeekAmount();
