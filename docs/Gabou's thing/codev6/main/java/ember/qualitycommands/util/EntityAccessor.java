...
public abstract interface EntityAccessor {
	public abstract void fixAttributes(Entity entity, Entity identity);
	...
	public abstract EntityDimensions getEntityDimensions();
	public abstract void setEntityDimensions(EntityDimensions dimensions);
	public abstract float getStandingEyeHeight();
	public abstract void setStandingEyeHeight(float standingEyeHeight);
	public abstract Entity getIdentityOwner();
    public abstract void setIdentityOf(Entity e);
    ...
    public abstract void setAbilityCooldown(int cooldown);
